...
public class LentoHorisontti {
    ...
    private static final double radiusEarth = 6371000; // maapallon säde [m]
    ...
    public static void main(String[] args) {
        ...
        System.out.println("lentokoneen kulkema matka [m] = " + lentokoneenKulkemaMatka);
        System.out.println("lentokoneen maanopeus [m/s] = " + lentoNopeusMs);
         */
        lentokoneenKulkemaIlmaMatkaM = alfaRad * (radiusEarth + lentoKorkeus); // metriessä
